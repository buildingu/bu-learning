...
import AuthContext, { AuthContextProvider } from "./components/4.UseContextChallenge/AuthContext";
...
function App() {
  ...
  switch (hookName) {
    ...
    case "useContext":
      return <AuthContextProvider><UseContextChallenge/> </AuthContextProvider>; //direct to the source of the folder
    case "useReducer":
